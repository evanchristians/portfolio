            ...
            <Flex>
                ...
                <div>
                    <p>
                        ...
                        <strong>full stack</strong> web development and strong
                        interests in <strong>experience design</strong> and{" "}
                    ...
                    <p>
                        ...
                        <strong>CodeSpace</strong>, where I was taught the
                        basics of <strong>Full Stack Web Development</strong> in{" "}
